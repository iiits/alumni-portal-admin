...
const defaultBarKeys = [
  ...
  { key: "admin", color: "#f87171", label: "Admin" },
  { key: "alumni", color: "#4ade80", label: "Alumni" },
  { key: "student", color: "#fbbf24", label: "Student" },
  { key: "growthRate", color: "#0ea5e9", label: "Growth Rate (%)" },
];
